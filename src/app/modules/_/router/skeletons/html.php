...
<html lang="en" dir="<?php $app->config['details']['root']; ?>">
  ...
  <body>
    ...
    <div class="page-content">
      <?php require_once __DIR__ . '/pages/' . $app->get('hostname') . '/' . $page['target'] . '.php'; ?>
    </div>
    <?php require_once __DIR__ . '/global/footer.php'; ?>
  </body>

  <script src="<?php echo ($app->config['details']['ssl'] ? 'https://' : 'http://') . $app->config['details']['domain'] . $app->config['details']['root']; ?>assets/js/global.js" type="text/javascript"></script>
</html>
